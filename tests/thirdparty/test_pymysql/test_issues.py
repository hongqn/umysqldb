...
KEY (`station`,`dh`,`echeance`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;""")
    ...
    def test_issue_14(self):
        ...
        self.assertEqual('1', oursql.converters.escape_item(1, "utf8"))
        self.assertEqual('1', oursql.converters.escape_item(1L, "utf8"))

        self.assertEqual('1', oursql.converters.escape_object(1))
        self.assertEqual('1', oursql.converters.escape_object(1L))
